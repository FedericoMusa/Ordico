from PyQt5.QtWidgets import (
    QDialog, QLabel, QLineEdit, QPushButton, QGridLayout, QMessageBox, QComboBox
)
import re
...
class RegisterWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.cmb_rol.addItems(["usuario", "cajero", "gerente"])
        ...
        layout.addWidget(self.lbl_rol, 4, 0)
        layout.addWidget(self.cmb_rol, 4, 1)
        layout.addWidget(self.btn_registrar, 5, 0, 1, 2)
    ...
    def registrar_usuario(self):
        ...
        try:
            ...
            crear_usuario(usuario, password, email, rol)
